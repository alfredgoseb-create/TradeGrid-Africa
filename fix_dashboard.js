const fs = require('fs');
const avg = "products.length ? (products.reduce((acc, item) => acc + Number(item.price || 0), 0) / products.length).toFixed(2) : '0.00'";
      ...
      <div className="max-w-6xl mx-auto p-6">
        ...
        <div className="grid md:grid-cols-2 gap-6 mb-10">
          ...
          <div className="bg-white rounded-xl shadow p-6">
            ...
            <p className="text-gray-500">Average price: N${` + '{' + avg + '}' + `</p>
          </div>
        </div>
        <div className="bg-white rounded-xl shadow p-6">
